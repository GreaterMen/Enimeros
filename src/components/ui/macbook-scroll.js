...
const rotate = useTransform(scrollYProgress, [0.05, 0.08, 0.2], [-28, -28, 0]);
  ...
  return (
    (<div
      ref={ref}
className="min-h-screen flex flex-col items-center py-20 md:py-40 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100 scale-[0.35] sm:scale-50"
    >      <motion.h2
        style={{
    ...
    (<div className="relative [perspective:800px]">
      ...
      <motion.div
        ...
        <Image
          ...
          alt="aceternity logo"
          fill
          className=" object-left-top absolute rounded-lg inset- h-full w-full% " />
      </motion.div>
    </div>)
  );
};
